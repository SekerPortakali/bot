...
client.emojiler = {
  gold: "796464601569951814", //?PARAM DAKİ ALTIN EMOJİSİ
  paraGitti: "796465745021763595", // X İŞARETİ
  paraGitmedi: "796466177814953985", // TİK İŞARETİ
  paraROZET: "796322137320849438", // PARA İLE ALINAN YILDIRIM ROZET EMOJİSİ
  onayRozet: "796461557537701909", // ONAY ROZETİ
  modRozet: "796462557996515328", // MOD ROZETİ
  yetkiliRozet: "796459613351837716", // YETKİLİ ROZETİ
  destekçiRozet: "796460493174210610",
  evet: "796328650365468672", // TİK İŞARET
  hayır: "796328656997449729", // X İŞARETİ
  acikk: "618934482992627743",
  kapalii: "690266213426790480",
  kendineParaYollama: "796328645106729011", // KENDİNE PARA ATMAYA ÇALIŞANLAR İÇİN SİNİRLİ EMOJİSİ
  konfeti: "796328651208523806", // MESLEK SAHİBİ OLUNCA RENGARENK KONFETİ ATIYOR
  yukleniyor: "796328653389561866", // YÜKLENİYOR EMOJİ İŞTE :D
  sinirli: "796467261186506833", // TİTREYEN SİNİRLİ :D
  mutlu: "796461016070357044", // MUTLU EMOJİ
  rahatsızetme: "738028497871568947", // RAHATSIZ ETMEYİN EMOJİSİ
  çevrimiçi: "738028506776338563", // ÇEVRİMİÇİ EMOJİSİ
  yayıncı: "738028492335218779", // YAYINCI EMOJİSİ
  çevrimdışı: "738028496806477916", // ÇEVRİM DIŞI EMOJİSİ
  boşta: "738028505677299722", // BOŞTA EMOJİSİ
  bot: "796463660570247208", // BOT EMOJİSİ
  polis: "738028585696362516", // POLİS EMOJİ
  Yvar: "796328650365468672", // YETKİLERİM KOMUDUNDAKİ TİK İŞARETİ
  Yyok: "796328656997449729", // YETKİLERİM KOMUDUNDAKİ X İŞARETİ
  yan: "796468816581230634", // > GİBİ EMOJİ İŞTE :ç
  kalpSarılmalı: "796467821101187083",
  olumlu: "",
  olumsuz: "",

  // AYARLAR KOMUDUNDAKİ AÇIK KAPALI EMOJİLERİ >>>>>>>>>>>>>>>>>
  kapalıA: "690266213426790480",
  açıkA: "796328650365468672",
...
client.ayarlar = {
  oynuyor: "w!yardım | w!destek",
  official_sahip: ["593192782898659328","463276938690035713"],
  sahip: "593192782898659328",

  yardimcilar: ["463276938690035713"],
  isim: "TheWolfs",
  botD:
    "https://discordapp.com/oauth2/authorize?client_id=795019901013327934&scope=bot&permissions=8",
  webS: "https://thewolfs-dashboard.glitch.me/",
  web: "https://thewolfs-dashboard.glitch.me/",
  site: "https://thewolfs-dashboard.glitch.me/",
  dblO: "https://discordbots.org/bot/795019901013327934/vote",
  dbl: "https://discordbots.org/bot/795019901013327934",
  dbltoken: process.env.DBLTOKEN,
  webpanel: "https://thewolfs-dashboard.glitch.me/",
  versiyon: "2.0",
  prefix: "w!",
  renk: "0x949494",
  version: "1.0.0"
...
client.on("message", async message => {
  ...
  if (command === "rozet-parar") {
    if (message.author.id !== "593192782898659328")
...
let i = db.fetch(`üyelikk_${msg.author.id}`)
  ...
  .setDescription(`${client.emojis.get(client.emojiler.evet)} Hizzaya Geçin! Burada Bir Gold Üye Belirdi! <@${msg.author.id}>`)
  .setColor("BLUE")
