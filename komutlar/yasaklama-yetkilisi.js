...
${client.emojis.get(client.emojiler.paraGitmedi)} Bancı Rolünü Ayarlamak İçin, Bancı Verilecek Rolü Etiketlemelisiniz
Örnek: \`w!yasaklama-yetkilisi @bansorumlusu\`

Eğer Etiketlenmiyorsa Rol Ayarlarından \`O Role Herkese Bu Rolden Bahsetme Yetkisi Tanı Vermelisiniz.\`
`)
  }
  message.channel.send(`${client.emojis.get(client.emojiler.yan)} ${rol} Rolü Olan Her Kullanıcı İnsanları w!ban Komutu İle Banlayabilicektir Rolü Verirken Dikkatli Olunuz.`)
