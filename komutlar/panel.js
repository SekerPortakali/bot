...
exports.run = async(client, message, args) => {
  ...
  message.channel.send(new Discord.RichEmbed().setColor(client.ayarlar.renk).setTitle('Sunucu Panel').setDescription('Gerekli dosaylar kurulsun mu?').setFooter('Onaylıyorsanız 15 saniye içerisinde "evet" yazmalısınız.'))
  .then(() => {
