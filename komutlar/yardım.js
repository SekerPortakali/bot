...
const footer = `[${dil.special.botinvite}](https://discordapp.com/oauth2/authorize?client_id=${client.user.id}&scope=bot&permissions=8) | [${dil.special.supportserver}](https://discord.gg/UUp4QetMd3) | [${dil.special.DBLpage}](${client.ayarlar.webpanel})`;
...
${footer}`];
            ...
            .setImage('https://i.hizliresim.com/hC3T4G.jpg')
...
*/
    ...
    .setAuthor(`${dil.menüü}`, 'https://i.hizliresim.com/hC3T4G.jpg')
    .setImage('https://i.hizliresim.com/hC3T4G.jpg')
    .setColor(client.ayarlar.renk)
    .setDescription(`
${footer}\n
